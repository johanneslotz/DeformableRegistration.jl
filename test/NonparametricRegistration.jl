...
@time deformationField = registerImagesNonparametric(refImg,temImg,options,measureDistance=ssdDistance)
ssdvalue = ssdDistance(refImg,temImg,getCellCenteredGrid(refImg)+deformationField,options)[1]
...
# register images nonparametric
@time deformationField = registerImagesNonparametric(refImg,temImg,options,measureDistance=ssdDistanceMatrixFree)
ssdvalue = ssdDistance(refImg,temImg,getCellCenteredGrid(refImg)+deformationField,options)[1]
@test_approx_eq_eps ssdvalue 124.077 1e-1
