...
# register images
@time affineParameters = registerImagesParametric(refImg,temImg, options, measureDistance=ssdDistance)

finalDistanceSSD = ssdDistance(refImg,temImg,transformGridAffine(centeredGrid,affineParameters),options)
...
@time affineParameters = registerImagesParametric(refImg,temImg,options ,measureDistance=ssdDistanceMatrixFree)
finalDistanceSSD = ssdDistance(refImg,temImg,transformGridAffine(centeredGrid,affineParameters),options)
