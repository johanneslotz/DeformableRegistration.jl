...
options.levels = [4, 3, 2, 1, 0]
    options.regularizerWeight = 0.8
    @time singleGridDisplacement = registerNonParametricFixedGridResolution(refImg, temImg, options,
                                    regularizerOperator=reg, interpolationScheme=interpolationScheme, gridLevel=2) # regularizerOperator=createDiffusiveOperatorCentered
